...
if (isset($_POST["block"])) {
    ...
    header("location:non_verified_users.php?success=user blocked!");
  ...
  <!-- Start wrapper-->
   <div id="wrapper">
    ...
    <!--Start sidebar-wrapper-->
     ...
     <?php
// require_once 'includes/profile_sidebar.php';
?>
     <!--End sidebar-wrapper-->
...
?>
     <a href="non_verified_users.php?q=alphebeticsort"><button class="btn btn-primary">sort  alphabetically</button></a><br>
  <a href="non_verified_users.php"><button class="btn btn-primary">sort by  time</button></a>
  ...
  <tr>
   ...
   <td class="inheader" ><b>block</b></td>
...
if (count($users) > 0) {
    foreach ($users as $row) {
        ...
        echo '<tr>
         ...
         <td class="inheader">
         <form method="POST" action="non_verified_users.php" onsubmit="return confirm(\'Are you sure you want to submit this form?\')">
...
?>
  ...
  <!--start overlay-->
    ...
    <?php
// require_once 'includes/profile_scripts.php';
?>
